...
from netwk import Decoder, Encoder
...
class VQVAE(nn.Module):
    def __init__(
        ...
        ddconfig = dict(
            ...
            in_channels=3, ch_mult=ch_mult, num_res_blocks=2,   # from vq-f16/config.yaml above # (1, 1, 2, 2, 4)
        ...
        self.quantize: VectorQuantizer2 = VectorQuantizer2(
            vocab_size=vocab_size, Cvae=self.Cvae, beta=beta,
